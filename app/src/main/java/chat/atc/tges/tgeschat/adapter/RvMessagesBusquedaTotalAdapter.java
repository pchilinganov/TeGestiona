...
public class RvMessagesBusquedaTotalAdapter extends RecyclerView.Adapter<RvMessagesBusquedaTotalAdapter.MyViewHolder> implements Filterable {
    private Context mContext;
    private List<Message> messages;
    private List<Message> mFilteredMessagesList = new ArrayList<>();
    private List<Message> listaMessage= new ArrayList<>();
    private MessageBusquedaTotalAdapterListener listener;
    ...
    public RvMessagesBusquedaTotalAdapter(Context mContext, List<Message> messages, MessageBusquedaTotalAdapterListener listener) {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                else
                {
                    ...
                    for (Message oMessage : varPublicas.listaMensajesbandeja) {
                        ...
                        if(fecha.toLowerCase().contains(charString) || ticket.toLowerCase().contains(charString) || tipo.toLowerCase().contains(charString) || nroConsulta.toLowerCase().contains(charString) || motivo.contains(charString)) {
    ...
    private void applyClickEvents(final MyViewHolder holder, final int position) {
        ...
        holder.messageContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("key_EstadoEncuestaConsulta",String.valueOf(messages.get(position).getEstadoEncuesta()));
        ...
        holder.messageContainer.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                if(messages.get(position).getEstado().equalsIgnoreCase("Abierto") && varPublicas.idCanal.equalsIgnoreCase("2841")) // Sólo se podrán comentar los tickets abiertos y si el usuario es de canal POSTVENTA
                {
                    ComentarioTicket_dialog.nroTicket = String.valueOf(messages.get(position).getId());
    ...
    private void ComentarioTicket_dialog()
    {
        ...
        myDiag.show(BandejaActivity222.fragmentManager, "ComentarioTicket_dialog");
    }
    ...
    public interface MessageBusquedaTotalAdapterListener {
